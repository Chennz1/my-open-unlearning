...
output_base="/cnz/data/project/my-open-unlearning/saves/unlearn/tv_reinforce_forget10_Llama-2-7b-chat-hf_mlp"
mkdir -p ${output_base}
...
for alpha in "${alphas[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=${device} python scripts/effiecient_task_vector.py \
