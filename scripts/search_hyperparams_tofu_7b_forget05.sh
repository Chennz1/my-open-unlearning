...
forget_path="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_Llama-2-7b-chat-hf_forget05_epoch10"
retain_mimic_path="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_Llama-2-7b-chat-hf_retain95_mimic_epoch10"

# Output base directory
output_base="/cnz/data/project/my-open-unlearning/saves/unlearn/hyperparam_search_forget05_7b_mlp_e10"
mkdir -p ${output_base}
...
for alpha in "${alphas[@]}"; do
    for beta in "${betas[@]}"; do
        ...
        CUDA_VISIBLE_DEVICES=${device} python scripts/model_merge_tofu_7b_forget05.py \
