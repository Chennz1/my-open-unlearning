...
retain_mimic_path="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_Llama-2-7b-chat-hf_retain90_mimic_epoch5"

# Output base directory
output_base="/cnz/data/project/my-open-unlearning/saves/unlearn/hyperparam_search_forget10_7b_mlp"
mkdir -p ${output_base}
