...
forget_path="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_phi-1_5_reinforce_forget05_epoch10"

# Output base directory
output_base="/cnz/data/project/my-open-unlearning/saves/unlearn/tv_reinforce_forget05_phi_mlp_e5"
mkdir -p ${output_base}
