...
def parse_args():
    ...
    parser.add_argument(
        "--tokenizer_path",
        type=str,
        default="/cnz/data/hf-home/hub/hub/models--microsoft--phi-1_5/snapshots/77aa61eeac94fbf33d492b9f2744c98b42d5b5eb/",
    ...
    parser.add_argument(
        "--ft_model_path",
        type=str,
        default="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_phi-1_5_full",
    ...
    parser.add_argument(
        "--forget_path",
        type=str,
        default="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_phi-1_5_forget05_epoch5",
        help="Path to forget model"
    )
    parser.add_argument(
        "--retain_mimic_path",
        type=str,
        default="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_phi-1_5_retain95_mimic_epoch5",
    ...
    parser.add_argument(
        "--save_path",
        type=str,
        default="/cnz/data/project/my-open-unlearning/saves/unlearn/test_model_phi_05_epoch5",
...
def main():
    ...
    filter_func = lambda n, p: True if "proj" in n or "dense" in n or "fc" in n else False
