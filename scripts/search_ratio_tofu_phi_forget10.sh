...
output_base="/cnz/data/project/my-open-unlearning/saves/unlearn/ratio_search_forget10_phi_mlp_e5"
mkdir -p ${output_base}
...
for ratio in "${ratios[@]}"; do
    ...
    retain_mimic_path="${retain_mimic_base}/tofu_phi-1_5_retain90_mimic_epoch5_ratio_1_${ratio_str}"
