...
def parse_args():
    parser = argparse.ArgumentParser(description="Model merge script for MUSE unlearning")
    
    # Model paths
    parser.add_argument(
        "--tokenizer_path",
        type=str,
        default="/cnz/data/ms-home/Llama-2-7b-hf",
    ...
    parser.add_argument(
        "--save_path",
        type=str,
        default="/cnz/data/project/my-open-unlearning/saves/unlearn/test_model_muse_news_mlp",
