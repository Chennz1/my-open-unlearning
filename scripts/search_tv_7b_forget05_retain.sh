...
forget_path="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_Llama-2-7b-chat-hf_reinforce_forget05_epoch10"
retain_path="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_Llama-2-7b-chat-hf_reinforce_retain95_epoch10"

# Output base directory
output_base="/cnz/data/project/my-open-unlearning/saves/unlearn/tv_reinforce_forget05_comp_Llama-2-7b-chat-hf_mlp"
mkdir -p ${output_base}
