...
forget_path="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_phi-1_5_forget10_epoch5"
retain_mimic_path="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_phi-1_5_retain90_mimic_epoch5"

# Output base directory
output_base="/cnz/data/project/my-open-unlearning/saves/unlearn/hyperparam_search_forget10_phi_mlp_e5"
mkdir -p ${output_base}
