...
def parse_args():
    ...
    parser.add_argument(
        "--forget_path",
        type=str,
        default="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_Llama-2-7b-chat-hf_forget05_epoch5",
        help="Path to forget model"
    )
    parser.add_argument(
        "--retain_mimic_path",
        type=str,
        default="/cnz/data/project/my-open-unlearning/saves/finetune/tofu_Llama-2-7b-chat-hf_retain95_mimic_epoch5",
    ...
    parser.add_argument(
        "--save_path",
        type=str,
        default="/cnz/data/project/my-open-unlearning/saves/unlearn/test_model_forget05_7b_mlp",
